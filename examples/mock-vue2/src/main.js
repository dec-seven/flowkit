...
import { ApprovalTaskList, ApprovalDetail, ApprovalActionBar, ApprovalTimeline } from '@flowkit/vue2';
...
const client = createApprovalClient({ adapter: createMockAdapter(), actor: { id: 'user-approver', name: '审批人' } });
